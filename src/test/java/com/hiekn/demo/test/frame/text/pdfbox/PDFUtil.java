package com.hiekn.demo.test.frame.text.pdfbox;
...
//            System.out.println(result);   
            IOUtils.write(result, new FileOutputStream(new File("C:\\Users\\DH\\Desktop\\quick\\test-data\\a.html")),"utf-8");
        } catch (Exception e) {   
    ...
    public static void main(String[] args) {   
        ...
        String fileName = "C:\\Users\\DH\\Desktop\\quick\\test-data\\x.pdf";  //这里先手动把绝对路径的文件夹给补上。   
...
//        pdfUtil.readPDF("C:\\Users\\DH\\Desktop\\quick\\test-data\\重构-改善既有代码的设计2010版.pdf");
    }   
}  