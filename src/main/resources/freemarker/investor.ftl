...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../libs/metronic/assets/global/plugins/jquery-multi-select/css/multi-select.css">
    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="/investors">投资方</a><i class="fa fa-circle"></i>
                </li>
                <li class="active">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="portlet light">
                        <div class="portlet-title"><input type="hidden" name="investorId">
                            <div class="caption">
                        ...
                        <div class="portlet-body">
                            <div id="content-elevator_pitch"></div>
                            <div class="margin-top-10" style="min-height:35px">
                                <span class="margin-right-10" style="color:#666"><i class="fa fa-reorder"></i>&nbsp;<span class="bold uppercase">投资阶段</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject bold uppercase"> 投资领域</span>
                                <span class="caption-helper"></span>
                            </div>
                            <div class="actions">
                                <span id="edit-domain" class="profile-edit btn btn-circle btn-default hide" data-toggle="modal" data-target="#modal-domain">
                                <i class="fa fa-pencil"></i> 编辑 </span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <div class="text-center hide" id="showAllStages">
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject bold uppercase"> 投资组合</span>
                                <span class="caption-helper"></span>
                            </div>
                            <div class="actions">
                                <span id="edit-inv-event" class="profile-edit btn btn-circle btn-default hide" data-toggle="modal" data-target="#modal-inv-event">
                                <i class="fa fa-plus"></i>添加</span>
                            </div>
                            <div class="input-group input-medium pull-right" id="inv-filter">
                                <input type="text" class="form-control" placeholder="筛选 名称/轮次/日期/金额">
                            </div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <div class="text-center hide" id="showInvestorStartups">
                                <a href="javascript:void(0);"><i class="fa fa-angle-double-down"></i>&nbsp;加载全部</a>
                                <a href="javascript:void(0);" class="hide"><i class="fa fa-angle-double-up"></i>&nbsp;收 起</a>
                            </div>
                        </div>
                            ...
                            <div class="table-scrollable table-scrollable-borderless">
                                <table class="table table-hover table-light">
                                   <!-- <thead>
                                    ...
                                    <tbody id="colleagues_container"></tbody>
                                </table>
                                <div class="text-center no-result hide">未收录相关信息</div>
                            </div>
...
<div class="modal fade" id="modal-upload_profile_img" tabindex="-1" role="dialog" aria-labelledby="modal-label-upload_profile_img" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="modal-label-upload_profile_img">上传LOGO</h4>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="modal-basic-info" tabindex="-1" role="dialog" aria-labelledby="modal-label-basic-info" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">投资阶段</label>
                            <div class="col-md-10">
                                <select multiple="multiple" class="multi-select" id="my_multi_select" name="investmentStage">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取 消</button>
                <button type="button" class="btn btn-primary" id="save-basic-info" data-style="zoom-out">保 存</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modal-domain" tabindex="-1" role="dialog" aria-labelledby="modal-label-basic-info" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="modal-label-domain">投资领域</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-body">
                        <div class="form-group">
                           <!-- <label class="col-md-2 control-label">投资阶段</label>-->
                            <div class="col-md-12">
                                <select multiple="multiple" class="multi-select" id="my_multi_select2" name="focusAreas">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取 消</button>
                <button type="button" class="btn btn-primary" id="save-domain">保 存</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modal-inv-event" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">新增投资组合</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-body">
                        <div class="form-group">
                            <label class="col-md-2 control-label">投资项目<span class="required" aria-required="true">*</span></label>
                            <div class="col-md-9">
                                <input type="hidden" name="id">
                                <input type="hidden" name="startupId">
                                <input type="text" class="form-control input-lg user-search" ty="2" name="startupName" placeholder="投资项目">
                                <div id="suggestion-startup" class="col-md-12 suggestion-list hide" style="top: 0;"></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">投资轮次<span class="required" aria-required="true">*</span></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">投资时间<span class="required" aria-required="true">*</span></label>
                            <div class="col-md-9">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn blue" id="addInvEvent">保 存</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<div class="modal fade" id="modal-claim" tabindex="-1" role="dialog" aria-labelledby="modal-label-claim" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="modal-label-claim">认领投资方</h4>
            </div>
            <div class="modal-body">
...
<script type="text/javascript" src="../libs/metronic/assets/global/plugins/jquery-multi-select/js/jquery.multi-select.js"></script>
...
<script src="../js/investor.js" type="text/javascript"></script>
<!-- END JAVASCRIPTS -->
</body>
<!-- END BODY -->
</html>